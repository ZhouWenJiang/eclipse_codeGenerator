...
public class DefaultDatabase extends Database {
  ...
  /*
   * (non-Javadoc)
   * @see org.joy.db.Database#getTable(java.lang.String, java.lang.String,
   * java.lang.String)
   */
  @Override
   ...
   * @param table
   * @param colCommentSql
   *          查询表中列注释的SQL, 含一个占位符 (tableName)
   * @param columnColumnName
   *          字段名列列名
   * @param columnComments
   *          注释列列名
   * @throws SQLException
