 ...
 */
package com.zz.eclipse.plugins.db.model;
...
public class Column implements Serializable {
  ...
  public boolean isPrimitiveType() {
    ...
    return JavaTypeResolver.isInteger(javaType) || JavaTypeResolver.isDouble(javaType)
        || JavaTypeResolver.isFloat(javaType) || JavaTypeResolver.isLong(javaType) || JavaTypeResolver.isShort(javaType)
        || JavaTypeResolver.isBoolean(javaType) || JavaTypeResolver.isByte(javaType);
  }
