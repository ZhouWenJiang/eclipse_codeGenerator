...
public class FreeMarkerImpl implements TemplateEngine {
  ...
  @Override
  public void processToFile( Map<String, Object> model, CodeGeneratorConfiguration codeGeneratorConfig )
    ...
    try {
      ...
      Writer out =
          new BufferedWriter(new OutputStreamWriter(new FileOutputStream(file), codeGeneratorConfig.getEncoding()));
